...
<?php endif; ?>
        ...
        <div class="flex items-center justify-center mt-4 gap-1">
            Belum punya akun? 
            <a class="underline font-bold text-gray-700 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="<?php echo e(route('register')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\Laragon\laragon\www\laundry\resources\views/auth/login.blade.php ENDPATH**/ ?>