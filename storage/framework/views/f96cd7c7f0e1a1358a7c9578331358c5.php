...
<?php endif; ?>
                <button type="button"
                    ...
                    <!-- eye off (hidden) - awalnya tersembunyi -->
                    <svg id="eyeClosed" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 hidden" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M13.875 18.825A10.05 10.05 0 0112 19c-4.477 0-8.268-2.943-9.542-7a9.956 9.956 0 012.223-3.637m1.77-1.77A9.963 9.963 0 0112 5c4.477 0 8.268 2.943 9.542 7a9.98 9.98 0 01-1.274 2.302" />
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M3 3l18 18" />
                    </svg>
                </button>
...
<?php endif; ?>
        ...
        <div class="mt-4">
            <?php if (isset($component)) { $__componentOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'phone','value' => __('Nomor Telepon')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
            ...
            <div class="flex items-center border rounded-lg overflow-hidden">
                ...
                <?php if (isset($component)) { $__componentOriginal18c21970322f9e5c938bc954620c12bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'phone','class' => 'flex-1 border-0 focus:ring-0','type' => 'tel','name' => 'phone','value' => old('phone'),'autocomplete' => 'tel','placeholder' => '812-3456-7890','inputmode' => 'numeric','pattern' => '[0-9]*','oninput' => 'this.value = this.value.replace(/[^0-9]/g, \'\');']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'phone','class' => 'flex-1 border-0 focus:ring-0','type' => 'tel','name' => 'phone','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('phone')),'autocomplete' => 'tel','placeholder' => '812-3456-7890','inputmode' => 'numeric','pattern' => '[0-9]*','oninput' => 'this.value = this.value.replace(/[^0-9]/g, \'\');']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
...
<?php endif; ?>
            <textarea id="address" name="address"
                class="block mt-1 w-full border-gray-300 dark:border-gray-700 focus:border-indigo-500 dark:focus:border-indigo-600
...
<?php endif; ?>
        ...
        <div class="flex items-center justify-center mt-4 gap-1">
            Sudah punya akun? 
            <a class="underline font-bold text-gray-700 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="<?php echo e(route('login')); ?>">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    toggleConfirm.addEventListener('click', function () {
        ...
        toggleConfirm.setAttribute('aria-pressed', String(isPassword));
        toggleConfirm.setAttribute('aria-label', isPassword ? 'Sembunyikan konfirmasi password' : 'Tampilkan konfirmasi password');
        eyeOpenConfirm.classList.toggle('hidden', !isPassword);
        eyeClosedConfirm.classList.toggle('hidden', isPassword);
    });
    // opsional: toggle saat menekan dan menahan tombol (mobile-friendly)
    toggleBtn.addEventListener('mousedown', (e) => e.preventDefault());
    toggleConfirm.addEventListener('mousedown', (e) => e.preventDefault());
});
</script><?php /**PATH C:\Laragon\laragon\www\laundry\resources\views/auth/register.blade.php ENDPATH**/ ?>